...
def run(context):
    ...
    try:
        ...
        # newInputNumber5=ui.inputBox("Enter Thickness: ","User Parameter Thickness",csHeightValue)
        ...
        w2=icsWidth-2*Thickness
        h2=icsHeight-2*Thickness
        ...
        pointC = adsk.core.Point3D.create(25, 62+(WheelBase*0.1069),0)
        # pointD = adsk.core.Point3D.create(25, 267, 0)
        pointD = adsk.core.Point3D.create(25, 62+(WheelBase*0.1069)+(WheelBase*0.7297), 0)
        # pointE = adsk.core.Point3D.create(-10, 307, 0)
        pointE = adsk.core.Point3D.create(-10, 62+(WheelBase*0.1069)+(WheelBase*0.7297)+(WheelBase*0.1633), 0)
        # pointF = adsk.core.Point3D.create(-10, 398, 0)
        pointF = adsk.core.Point3D.create(-10, 62+91+(WheelBase*0.1069)+(WheelBase*0.7297)+(WheelBase*0.1633), 0)
        ...
        # planeInput21.setByTangent(face1, angle, rootComp.yZConstructionPlane)
        # planes.add(planeInput21)
        ...
        centerPoint = adsk.core.Point3D.create(0, 45, 0)
        cornerPoint1 = adsk.core.Point3D.create(h/2, 45+w/2, 0)
        ...
        cornerPoint1 = adsk.core.Point3D.create(25.25+w/2, 62+h/2+(WheelBase*0.1959), 0)
        ...
        cornerPoint1 = adsk.core.Point3D.create(25.25+w/2, 62+h/2+(WheelBase*0.1959)+(WheelBase*0.2857), 0)
        ...
        cornerPoint1 = adsk.core.Point3D.create(25.25+w/2, 62+h/2+(WheelBase*0.1959)+(WheelBase*0.2857*2), 0)
        ...
        cornerPoint1 = adsk.core.Point3D.create(-10-h/2,62+w/2+(WheelBase*0.1959)+(WheelBase*0.2857*2)+(WheelBase*0.2326)+18 , 0)
        ...
        centerPoint = adsk.core.Point3D.create(-10, 4.3+62+91+(WheelBase*0.1069)+(WheelBase*0.7297)+(WheelBase*0.1633), 0)
        ...
        cornerPoint1 = adsk.core.Point3D.create(-10-h/2,4.3+w/2+62+91+(WheelBase*0.1069)+(WheelBase*0.7297)+(WheelBase*0.1633) , 0)
        cornerPoint2 = adsk.core.Point3D.create(-10-csHeight/2, 4.3+csWidth/2+62+91+(WheelBase*0.1069)+(WheelBase*0.7297)+(WheelBase*0.1633), 0)
        ...
        distance22 = adsk.core.ValueInput.createByReal(Width+57.2)
